                ...
                <ul class="glide__slides">
                    ...
                    <?php
                        ...
                        $posts = get_posts( array(
                            ...
                            'category_name'    => "slider", //имя категории
                            'orderby'     => 'date',
                            'order'       => 'ASC',
                            'post_type'   => 'post',
                        ...
                        foreach( $posts as $post ){
                            ...
                            ?>
                                ...
                                <li style="background-image: url('<?php the_field("Img_slide1")?>')" class="glide__slide">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-7 offset-1">
                                                <h2 class="slider__title" style="
                                                    <?php
                                                    $field = get_field("color_text_slide1");
                                                    if ($field == "white") {
                                                        ?>
                                                        color: #fff;
                                                        <?php 
                                                ...
                                                <?php
                                                    ...
                                                    if ($field == "on") {
                                                        ?>
                                                            <a href="<?php the_field("slider_btn")?>" class="button">Узнать больше</a>
                                                        <?php 
                                                    }
                                                    ?>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                           <?php the_field("adress_description"); ?>
                           <br><br>
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+797867834347"><?php the_field("phone_number1")?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+797867834358"><?php the_field("phone_number2")?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="contacts__mail">
                                <?php the_field("email_description")?>
                                <a href="mailto:mirdetstva@gmail.com"><?php the_field("name_email")?></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
