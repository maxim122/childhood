                    ...
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item">
                                ...
                                <a href="mailto:mirdetstva@gmail.com" class="header__contacts-mail"><?php the_field('e_mail', 2);?></a>
                            </div>
                            <div class="header__contacts-item">
                                ...
                                <div class="header__contacts-tel">
                                    <a href="tel:+797867834347"><?php the_field('number_phone', 2);?></a>
                                </div>
                            </div>
                            <div class="header__contacts-item">
